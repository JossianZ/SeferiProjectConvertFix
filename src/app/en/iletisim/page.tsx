...
export default function EnIletisimPage() {
  const { styles, scripts, bodyContent, metaTags, linkTags } = loadHTML('en/iletisim/index.html')
  return <PageWrapper styles={styles} scripts={scripts} bodyContent={bodyContent} metaTags={metaTags} linkTags={linkTags} />
}

export async function generateMetadata() {
  const { title } = loadHTML('en/iletisim/index.html')
  return { title: title || 'Contact - Seferi AI' }
}
